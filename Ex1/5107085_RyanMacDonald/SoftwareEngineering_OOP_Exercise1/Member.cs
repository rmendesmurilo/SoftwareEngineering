public class Member
{
    ...
    public static int totalMembers { private set; get; }
    ...
    public string MembershipLevel { private set; get; }
    ...
    private static int maxStandardBooks = 3;
    private static int maxPremiumBooks = 5;
    private static int maxVIPBooks = 10;
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        if (MembershipLevel == "standard")
            return maxStandardBooks;
        else if (MembershipLevel == "premium")
            return maxPremiumBooks;
    ...
    public void BorrowBook()
    {
        ...
        if (GetMaxBorrowLimit() > booksBorrowed)
        {
            booksBorrowed++;
            totalBooksBorrowed++;
        }
